...
beta_tip1 = 20;     % Ângulo de passo na ponta – hélice 1
beta_hub1 = 65;     % Ângulo de passo no cubo – hélice 1
beta_tip2 = 15;     % Ângulo de passo na ponta – hélice 2
beta_hub2 = 60;     % Ângulo de passo no cubo – hélice 2
beta_tip3 = 10;     % Ângulo de passo na ponta – hélice 3
beta_hub3 = 55;     % Ângulo de passo no cubo – hélice 3
...
beta_hub = beta_hub1;
beta_tip = beta_tip1;
beta1 = calcula_beta(beta_hub, beta_tip, R_hub, R_tip,r); %para a primeira hélice
beta_hub = beta_hub2;
beta_tip = beta_tip2;
beta2 = calcula_beta(beta_hub, beta_tip, R_hub, R_tip,r); %para a segunda hélice
beta_hub = beta_hub3;
beta_tip = beta_tip3;
beta3 = calcula_beta(beta_hub, beta_tip, R_hub, R_tip,r); %para a terceira hélice

% Passo (pitch distance) 
P_D = tan(beta1)*2*pi*(0.75*R_tip);
...
alpha = beta1 - phi + alpha_zl;         % ângulo de ataque no elemento

%%  Forças aerodinâmicas no elemento

Cl = Cl_alpha_compressivel.*(beta1 - phi + alpha_zl - alpha_i); % coeficiente de sustentação do perfil
